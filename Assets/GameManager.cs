...
{
    //public float speed = 10.0f; //필드 : public 하면 객체지향의 철학과 동떨어짐
    ...
    //singleton pattern : 클래스 하나에 인스턴스가 하나만 생성되는 프로그래밍 패턴
    private static GameManager _instance = null; //멤버 변수 선언, 정의 = 필드(field) 선언 → private, protected 선언 외부에서 접근 불가능
